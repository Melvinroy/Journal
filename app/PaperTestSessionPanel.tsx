...
export function PaperTestSessionPanel({paper}: {paper: PaperExecution}) {
  ...
  return <details className="workspace-notice">
    ...
    <p>Resuming after a repair approves the current source only after all earlier campaigns are closed, fees reconciled and orders cleared. Existing limits remain unchanged.</p>
