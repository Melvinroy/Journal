...
if ((Get-ScheduledTask -TaskName $TaskName -ErrorAction SilentlyContinue) -and -not $UpdateExisting) {
...
$trigger = New-ScheduledTaskTrigger -Weekly -WeeksInterval 1 -DaysOfWeek Tuesday,Wednesday,Thursday,Friday,Saturday -At '05:45'
$settings = New-ScheduledTaskSettingsSet -StartWhenAvailable -AllowStartIfOnBatteries -DontStopIfGoingOnBatteries `
  -DisallowHardTerminate -MultipleInstances IgnoreNew -ExecutionTimeLimit (New-TimeSpan -Hours 6)
