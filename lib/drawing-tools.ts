...
export const DRAWING_TOOLS: readonly DrawingToolDefinition[] = [
  ...
  { id: "eraser", label: "Eraser", groupId: "cursor", icon: "Eraser" },
  ...
  { id: "infoLine", label: "Info Line", groupId: "lines", icon: "Info" },
  ...
  { id: "flatChannel", label: "Flat Top/Bottom Channel", groupId: "channels", icon: "AlignTop" },
  { id: "fibRetracement", label: "Fibonacci Retracement", groupId: "fibonacci", icon: "Function", overlay: "fibonacciLine" },
  { id: "fibExtension", label: "Trend-Based Fibonacci Extension", groupId: "fibonacci", icon: "MathOperations" },
  ...
  { id: "datePriceRange", label: "Date & Price Range", groupId: "measureTrade", icon: "CalendarBlank" },
  ...
  { id: "highlighter", label: "Highlighter", groupId: "shapes", icon: "HighlighterCircle" },
  { id: "arrow", label: "Arrow", groupId: "shapes", icon: "Path", overlay: "brontide-arrow" },
  { id: "text", label: "Text", groupId: "annotations", icon: "TextT" },
  ...
  { id: "callout", label: "Callout", groupId: "annotations", icon: "ChatCenteredDots" },
] as const;
